<div class="content-wrapper">
    <section class="content-header">
        <h1>Coach User <small>listing of all coaches</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Coach User</li>
        </ol>
    </section>
...
<script type="text/javascript">
    $(function () {
        $('#coach_datatable').dataTable({
            "aaSorting": [['0', 'asc']],
            "sAjaxSource": base_url + "user/coach_datatable",
            "oTableTools": {
                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        },
                        {
                            ...
                            "mData": null,
                            "mRender": function (data, type, full) {
                                return '<a href="'+base_url+'user/earnings/'+full[0]+'" target="_blank"><i class="fa fa-eye"></i> View</a>';
                            }
                        },
                        {
                            "aTargets": [7],
